...
<div class="woocommerce-order">
	...
	if ( $order ) :
		...
		<?php if ( $order->has_status( 'failed' ) ) : ?>
			...
			<p class="woocommerce-notice woocommerce-notice--error woocommerce-thankyou-order-failed"><?php esc_html_e( 'Unfortunately your Contribution cannot be processed as the originating bank/merchant has declined your transaction. Please attempt your purchase again.', 'buddyboss-theme' ); ?></p>
		...
		<?php else : ?>
                ...
                <h2 class="woocommerce-heading--success woocommerce-thankyou-order-received-heading"><i class="bb-icon-check"></i><?php _e( 'Your Contribution is Confirmed', 'buddyboss-theme' ); ?></h2>

    			<p class="woocommerce-notice woocommerce-notice--success woocommerce-thankyou-order-received"><?php echo apply_filters( 'woocommerce_thankyou_order_received_text', __( 'Thank you. Your Contribution has been received.', 'buddyboss-theme' ), $order ); ?></p>
	...
	<?php else : ?>
		...
		<p class="woocommerce-notice woocommerce-notice--success woocommerce-thankyou-order-received"><?php echo apply_filters( 'woocommerce_thankyou_order_received_text', esc_html__( 'Thank you. Your Contribution has been received.', 'buddyboss-theme' ), null ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></p>
...
<div class="woocommerce-order-end">
        <h3 class="woocommerce-heading--end"><?php _e( 'Compaigns You Might Like ', 'buddyboss-theme' ); ?></h3>
        
<?php  //echo do_shortcode('[related_products limit="3"]');
//echo do_shortcode('[wpneo_crowdfunding_listing number="3" ]');
echo do_shortcode('[wpcf_popular_campaigns number="3" ]');
?>
