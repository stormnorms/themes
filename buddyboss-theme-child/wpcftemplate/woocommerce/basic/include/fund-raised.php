...
<div class="lead">
    ...
    <span class="thm-Price-amount">
        <span class="woocommerce-Price-amount amount"><?php echo wpcf_function()->price( wpcf_function()->fund_raised() ); ?></span>
    </span> 
    <span class="thm-raise-sp"><?php _e('Raised', 'backnow') ?></span>

    <div class="thm-meta-desc pull-right text-right">
        <span class="thm-Price-amount">
            <span class="woocommerce-Price-amount amount"><?php echo wpcf_function()->price( wpcf_function()->total_goal(get_the_ID()) ); ?></span>
        </span>
