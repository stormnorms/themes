    ...
    ?>
        ...
        <div class="backnow-bio">
            <div class="backnow-info-img">
                ...
                <a data-toggle="modal" data-target="#bioinfo" href="#" class="wpneo-fund-modal-btn"><?php echo wpcf_function()->get_author_name(); ?></a> 
            </div>
            ...
            <div class="wpneo-modal-content">
                ...
                <div class="wpneo-modal-content-inner">        
                    ...
                    <div class="wpneo-profile-right">
                        <div class="wpneo-profile-name"><?php echo wpcf_function()->get_author_name(); ?></div> 
                        <?php $profile_address = get_user_meta( get_current_user_id(), 'profile_address', true ); ?>
                        <?php if ($profile_address ): ?>
                        ...
                        <?php endif ?>
                        <div class="wpneo-profile-campaigns"><?php echo wpcf_function()->author_campaigns()->post_count.__( " Campaigns" , "backnow" ).' | '. wpcf_function()->loved_count().__( " Loved campaigns" , "backnow" ); ?></div>
                    </div>
                    ...
                    echo '<div class="wpneo-profile-about">';
                        ...
                        if ( ! empty($user_info['profile_website'][0])){
                            echo '<p>'.__("Website: ","backnow").' <a href="'.wpcf_function()->url($user_info['profile_website'][0]).'"> '.wpcf_function()->url($user_info['profile_website'][0]).' </a></p>';
                        }
                        if ( ! empty($user_info['profile_email1'][0])){
